...
--network bridge=virbr0,mac=52:54:00:87:f4:2f --network bridge=virbr0 --boot hd,network \
...
--network bridge=virbr0,mac=52:54:00:cc:51:86 --network bridge=virbr0 --boot hd,network \
...
--network bridge=virbr0,mac=52:54:00:67:34:25 --network bridge=virbr0 --boot hd,network \
